# RailsAdmin config file. Generated on September 06, 2013 18:38
...
RailsAdmin.config do |config|
  ...
  config.main_app_name = ['ShareAllTech SFDC', 'Admin']
  ...
  # config.excluded_models = ['Article', 'Comment', 'Site']

  # Include specific models (exclude the others):
  # config.included_models = ['Article', 'Comment', 'Site']
